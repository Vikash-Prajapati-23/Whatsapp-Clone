    ...
    <div className="bg-white fixed left-[65px] h-screen w-[450px] border-1 border-gray-300">
      ...
      <div className="fixed top-0 w-[450px] z-10">
        <div className="flex justify-between py-4 px-5">
          ...
          <div className="flex justify-center items-center cursor-pointer gap-5 me-4">
            <div
          ...
          {showCard && (
            <div
              ...
              className="absolute bottom-[-42%] right-[-26%] bg-white p-2 rounded-xl z-50"
            >
        ...
        <div className="flex gap-2 my-3 mx-auto bg-transparent w-[90%]">
