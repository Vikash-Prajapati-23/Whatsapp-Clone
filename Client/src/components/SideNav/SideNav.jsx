      ...
      <div className="flex flex-col">
        <div className="p-2 m-2">
          <ul className="flex justify-center mb-4 pb-4 border-b-1 border-gray-400 text-lg space-y-2 items-center flex-col ">
            <li className="bg-transparent hover:bg-gray-300 h-9 w-9 flex justify-center items-center p-1 rounded-full cursor-pointer">
            ...
            <li className="bg-transparent hover:bg-gray-300 h-9 w-9 flex justify-center items-center p-1 rounded-full cursor-pointer">
              <i className="fa-brands fa-whatsapp text-gray-400 text-2xl"></i>
            </li>

            <li className="bg-transparent hover:bg-gray-300 h-9 w-9 text-center p-1 rounded-full cursor-pointer">
              <i className="fa-solid fa-users text-gray-400"></i>
            </li>
          </ul>

          <div className="bg-transparent text-lg hover:bg-gray-300 h-9 w-9 p-1 rounded-full flex justify-center items-center cursor-pointer">
            <span class="material-symbols-outlined text-gray-400">circle</span>
          </div>
        </div>

        <div className="fixed bottom-3 left-[1%] space-y-3 text-lg">
          <div className="bg-transparent hover:bg-gray-300 h-9 w-9 text-center p-1 rounded-full cursor-pointer">
